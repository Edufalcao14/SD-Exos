...
public class SerieEtudiants {
	...
	public SerieEtudiants(int numero) {
		if (numero< 1) throw new IllegalArgumentException("numero doit etre plus grand que 1");
	...
	public boolean contientEtudiant(String nom){
		...
		if (listeEtudiants.isEmpty()) return false;
	...
	public boolean supprimerEtudiant(String nom){
		if(nom.equals("")|| nom==null) throw new IllegalArgumentException("");
		if (!listeEtudiants.contains(nom)) return false;

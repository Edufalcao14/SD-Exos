...
public class GestionDesSeries {
	...
	private static void rechercherSerie() {
		...
		System.out.println("Le numero de la serie de l'etudiant est : ");
		System.out.println(classe.numeroSerie(nom)+1);
	}
	...
	private static void afficherTailleSeries() {
		for (int i = 0; i <= classe.nombreSeries()-1; i++) {
			System.out.println("Numero d'etudians dans la serie " + (i+1) + " : " + classe.getSerieEtudiants(i).nombreEtudiants());
		}
	}

...
public class TestEnsembleVoituresAutorisees{
	...
	public static void main(String[] args) {	
		...
		if (e.retirerVoiture(new Voiture("1BBB000",""))){
			System.out.println("La supression a echoué");
		}else
		...
		if (!e.voitureAutorisee(new Voiture("1AAA999","")) && e.voitureAutorisee(new Voiture("1CCC000",""))){
			System.out.println("La verifications de la presece des voitures a echoué");
		}
		else
		...
		if (e.ajouterVoiture(new Voiture("1AAA999",""))){
			System.out.println("L'ajout a echoué , la voiture a deja ete present dans l'ensemble");
		}

...
public class ABRDEntiers {
    ...
    private void insere(NoeudEntier n, int entier) {
        if (entier < n.entier) {
            if (n.gauche == null) {
                n.gauche = new NoeudEntier(entier);
            } else {
                insere(n.gauche, entier);
            }
        } else {
            if (n.droit == null) {
                n.droit = new NoeudEntier(entier);
            } else {
                insere(n.droit, entier);
            }
        }
    }
    ...
    private boolean contient(NoeudEntier noeud, int entier) {
        ...
        if (noeud.entier == entier) return true;
    ...
    private int min(NoeudEntier noeud) {
        if (noeud.gauche == null) return noeud.entier;
